...
public class AnswerJoinPartyRoom extends ClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((_answer == 1) && !partner.isRequestExpired())
		{
			...
			{
				player.sendPacket(SystemMessageId.SINCE_YOU_DO_NOT_MEET_THE_REQUIREMENTS_YOU_ARE_NOT_ALLOWED_TO_ENTER_THE_PARTY_ROOM);
			}
		}
		else
		{
			partner.sendMessage("The recipient of your invitation did not accept the party matching invitation.");
		}
