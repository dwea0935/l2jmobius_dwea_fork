...
public class DlgAnswer extends ClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			final TerminateReturn term = EventDispatcher.getInstance().notifyEvent(new OnPlayerDlgAnswer(player, _messageId, _answer), player, TerminateReturn.class);
		...
		if (_messageId == SystemMessageId.S1_S2.getId())
		{
