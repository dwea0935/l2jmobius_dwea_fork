...
public class CommandChannel extends AbstractPlayerGroup
{
	...
	public CommandChannel(Player leader)
	{
		...
		party.broadcastMessage(SystemMessageId.A_COMMAND_CHANNEL_HAS_BEEN_OPENED);
	...
	public void addParty(Party party)
	{
		...
		party.setCommandChannel(this);
		party.broadcastPacket(new SystemMessage(SystemMessageId.YOU_HAVE_PARTICIPATED_IN_THE_COMMAND_CHANNEL));
		party.broadcastPacket(ExOpenMPCC.STATIC_PACKET);
	}
	...
	public void removeParty(Party party)
	{
		...
		if (_parties.size() < 2)
		{
			broadcastPacket(new SystemMessage(SystemMessageId.A_COMMAND_CHANNEL_HAS_BEEN_CLOSED));
			disbandChannel();
		}
		// else
		// {
