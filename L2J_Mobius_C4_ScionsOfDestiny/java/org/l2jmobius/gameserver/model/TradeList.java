...
public class TradeList
{
	...
	private void doExchange(TradeList partnerList)
	{
		...
		{
			partnerList.getOwner().sendPacket(SystemMessageId.INVENTORY_SLOT_IS_FULL);
			_owner.sendPacket(SystemMessageId.INVENTORY_SLOT_IS_FULL);
		}
		else
		{
	...
	public synchronized int privateStoreBuy(Player player, Set<ItemRequest> items)
	{
		...
		{
			player.sendPacket(SystemMessageId.INVENTORY_SLOT_IS_FULL);
			return 1;
		}
