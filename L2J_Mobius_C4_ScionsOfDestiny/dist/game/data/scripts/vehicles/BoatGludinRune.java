...
public class BoatGludinRune implements Runnable
{
	...
	public BoatGludinRune(Boat boat)
	{
		...
		ARRIVED_AT_GLUDIN_2 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_RUNE_HARBOR_AFTER_ANCHORING_FOR_TEN_MINUTES);
		LEAVE_GLUDIN5 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_RUNE_HARBOR_IN_FIVE_MINUTES);
		LEAVE_GLUDIN1 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_RUNE_HARBOR_IN_ONE_MINUTE);
		LEAVE_GLUDIN0 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.LEAVING_SOON_FOR_RUNE_HARBOR);
		LEAVING_GLUDIN = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.LEAVING_FOR_GLUDIN_HARBOR_2);
		ARRIVED_AT_RUNE = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.ARRIVED_AT_RUNE_HARBOR);
		ARRIVED_AT_RUNE_2 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_GLUDIN_HARBOR_AFTER_ANCHORING_FOR_TEN_MINUTES);
		LEAVE_RUNE5 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_GLUDIN_HARBOR_IN_FIVE_MINUTES_2);
		LEAVE_RUNE1 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_GLUDIN_HARBOR_IN_ONE_MINUTE_2);
		LEAVE_RUNE0 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.LEAVING_SOON_FOR_GLUDIN_HARBOR_2);
		LEAVING_RUNE = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.LEAVING_FOR_GLUDIN_HARBOR_2);
