...
public class BoatInnadrilTour implements Runnable
{
	...
	public BoatInnadrilTour(Boat boat)
	{
		...
		LEAVE_INNADRIL0 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.INNADRIL_PLEASURE_BOAT_IS_LEAVING_SOON);
		LEAVING_INNADRIL = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.INNADRIL_PLEASURE_BOAT_IS_LEAVING);
