...
public class BoatTalkingGludin implements Runnable
{
	...
	public BoatTalkingGludin(Boat boat)
	{
		...
		ARRIVED_AT_TALKING = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.ARRIVED_AT_TALKING_ISLAND_HARBOR);
		ARRIVED_AT_TALKING_2 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_GLUDIN_HARBOR_AFTER_ANCHORING_FOR_TEN_MINUTES);
		LEAVE_TALKING5 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_GLUDIN_HARBOR_IN_FIVE_MINUTES);
		LEAVE_TALKING1 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_GLUDIN_HARBOR_IN_ONE_MINUTE);
		LEAVE_TALKING1_2 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THOSE_WISHING_TO_RIDE_SHOULD_MAKE_HASTE_TO_GET_ON);
		LEAVE_TALKING0 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.LEAVING_SOON_FOR_GLUDIN_HARBOR);
		LEAVING_TALKING = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.LEAVING_FOR_GLUDIN_HARBOR);
		ARRIVED_AT_GLUDIN = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.ARRIVED_AT_GLUDIN_HARBOR);
		ARRIVED_AT_GLUDIN_2 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_TALKING_ISLAND_HARBOR_AFTER_ANCHORING_FOR_TEN_MINUTES);
		LEAVE_GLUDIN5 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_TALKING_ISLAND_HARBOR_IN_FIVE_MINUTES);
		LEAVE_GLUDIN1 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_TALKING_ISLAND_HARBOR_IN_ONE_MINUTE);
		LEAVE_GLUDIN0 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.LEAVING_SOON_FOR_TALKING_ISLAND_HARBOR);
		LEAVING_GLUDIN = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.LEAVING_FOR_TALKING_ISLAND_HARBOR);
