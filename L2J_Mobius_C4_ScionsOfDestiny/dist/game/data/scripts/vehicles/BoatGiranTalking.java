...
public class BoatGiranTalking implements Runnable
{
	...
	public BoatGiranTalking(Boat boat)
	{
		...
		ARRIVED_AT_GIRAN = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.ARRIVED_AT_GIRAN_HARBOR);
		ARRIVED_AT_GIRAN_2 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_TALKING_ISLAND_HARBOR_AFTER_ANCHORING_FOR_TEN_MINUTES);
		LEAVE_GIRAN5 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_TALKING_ISLAND_HARBOR_IN_FIVE_MINUTES);
		LEAVE_GIRAN1 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_TALKING_ISLAND_HARBOR_IN_ONE_MINUTE);
		LEAVE_GIRAN0 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.LEAVING_SOON_FOR_TALKING_ISLAND_HARBOR);
		LEAVING_GIRAN = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.LEAVING_FOR_TALKING_ISLAND_HARBOR);
		ARRIVED_AT_TALKING = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.ARRIVED_AT_TALKING_ISLAND_HARBOR);
		ARRIVED_AT_TALKING_2 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_GIRAN_HARBOR_AFTER_ANCHORING_FOR_TEN_MINUTES);
		LEAVE_TALKING5 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_GIRAN_HARBOR_IN_FIVE_MINUTES);
		LEAVE_TALKING1 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WILL_LEAVE_FOR_GIRAN_HARBOR_IN_ONE_MINUTE);
		LEAVE_TALKING0 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.LEAVING_SOON_FOR_GIRAN_HARBOR);
		LEAVING_TALKING = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.LEAVING_FOR_GIRAN_HARBOR);
