...
public class Pumping extends AbstractEffect
{
	...
	public void onStart(Creature effector, Creature effected, Skill skill)
	{
		...
		if (fish == null)
		{
			...
			player.sendPacket(SystemMessageId.PUMPING_SKILL_IS_AVAILABLE_ONLY_WHILE_FISHING);
		...
		{
			player.sendPacket(SystemMessageId.SINCE_THE_SKILL_LEVEL_OF_REELING_PUMPING_IS_HIGHER_THAN_THE_LEVEL_OF_YOUR_FISHING_MASTERY_A_PENALTY_OF_S1_WILL_BE_APPLIED);
			pen = (int) (dmg * 0.05);
			dmg -= pen;
		}
		if (ss > 1)
