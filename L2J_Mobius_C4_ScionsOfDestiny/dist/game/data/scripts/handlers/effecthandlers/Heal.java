	...
	public void onStart(Creature effector, Creature effected, Skill skill)
	{
		...
		if (effected.isPlayer())
		{
			...
			else
			{
				...
				{
					final SystemMessage sm = new SystemMessage(SystemMessageId.S2_S_HP_HAS_BEEN_RESTORED_BY_S1);
				...
				{
					final SystemMessage sm = new SystemMessage(SystemMessageId.S1_HPS_HAVE_BEEN_RESTORED);
					sm.addInt((int) amount);
					effected.sendPacket(sm);
				}
			}
