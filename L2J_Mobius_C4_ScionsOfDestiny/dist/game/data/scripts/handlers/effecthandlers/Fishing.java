...
public class Fishing extends AbstractEffect
{
	...
	public void onStart(Creature effector, Creature effected, Skill skill)
	{
		...
		if (player.isFishing())
		{
			...
			player.sendPacket(SystemMessageId.CANCELS_FISHING);
			return;
		}
		...
		{
			player.sendPacket(SystemMessageId.FISHING_POLES_ARE_NOT_INSTALLED);
			return;
		}
		...
		{
			player.sendPacket(SystemMessageId.BAITS_ARE_NOT_PUT_ON_A_HOOK);
			return;
		}
		
		if (player.isInBoat())
		{
			player.sendPacket(SystemMessageId.YOU_CAN_T_FISH_WHILE_YOU_ARE_ON_BOARD);
			return;
		}
		...
		{
			player.sendPacket(SystemMessageId.YOU_CAN_T_FISH_IN_WATER);
			return;
		}
