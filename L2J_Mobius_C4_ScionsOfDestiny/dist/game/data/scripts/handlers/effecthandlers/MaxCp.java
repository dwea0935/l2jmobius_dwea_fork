...
public class MaxCp extends AbstractEffect
{
	...
	public void onStart(Creature effector, Creature effected, Skill skill)
	{
		...
		if (_heal)
		{
			...
			{
				final SystemMessage sm = new SystemMessage(SystemMessageId.S1_WILL_RESTORE_S2_S_CP);
			...
			{
				final SystemMessage sm = new SystemMessage(SystemMessageId.S1_CP_S_WILL_BE_RESTORED);
				sm.addInt((int) amount);
				effected.sendPacket(sm);
			}
		}
