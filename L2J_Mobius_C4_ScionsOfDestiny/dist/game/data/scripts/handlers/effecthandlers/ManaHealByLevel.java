...
public class ManaHealByLevel extends AbstractEffect
{
	...
	public void onStart(Creature effector, Creature effected, Skill skill)
	{
		...
		final SystemMessage sm = new SystemMessage(effector.getObjectId() != effected.getObjectId() ? SystemMessageId.S2_S_MP_HAS_BEEN_RESTORED_BY_S1 : SystemMessageId.S1_MPS_HAVE_BEEN_RESTORED);
