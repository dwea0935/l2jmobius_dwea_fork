...
public class OlympiadManager
{
	...
	public boolean registerNoble(Player player, CompetitionType type)
	{
		...
		{
			player.sendPacket(SystemMessageId.YOU_MAY_PARTICIPATE_IN_UP_TO_25_MATCHES_PER_WEEK);
			return false;
		}
		...
		switch (type)
		{
			...
			case NON_CLASSED:
			{
				...
				player.sendPacket(SystemMessageId.YOU_VE_BEEN_REGISTERED_IN_THE_WAITING_LIST_OF_WORLD_OLYMPIAD);
				break;
			}
		}
		return true;
	...
	public boolean unRegisterNoble(Player noble)
	{
		...
		{
			final SystemMessage sm = new SystemMessage(SystemMessageId.C1_DOES_NOT_MEET_THE_PARTICIPATION_REQUIREMENTS_ONLY_CHARACTERS_THAT_COMPLETED_THE_2ND_CLASS_TRANSFER_CAN_PARTICIPATE_IN_THE_OLYMPIAD);
