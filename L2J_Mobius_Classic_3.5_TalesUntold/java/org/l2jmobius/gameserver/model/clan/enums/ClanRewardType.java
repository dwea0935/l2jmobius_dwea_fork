...
public enum ClanRewardType
{
	...
	RAID_ARENA(-1, Clan::getMaxRaidLevel);
	...
	public ClanRewardBonus getAvailableBonus(Clan clan)
	{
		...
		{
			int requiredAmount = bonus.getRequiredAmount();
			int currentPoints = _pointsFunction.apply(clan);
			if (requiredAmount <= currentPoints)
			{
